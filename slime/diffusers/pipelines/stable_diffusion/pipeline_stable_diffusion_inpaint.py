        ...
        if mask.shape[0] < batch_size:
            if not batch_size % mask.shape[0] == 0:
                raise ValueError(
                    ...
                    f" a total batch size of {batch_size}, but {mask.shape[0]} jsons were passed. Make sure the number"
                    " of jsons that you pass is divisible by the total requested batch size."
                )
